...
function demo_spearfish_packet(spearfish_message) {
	...
	if (spearfish_message.parsedIpcData.param2 == 3) { // this is a "caught fish" packet
	...
	} else if (spearfish_message.parsedIpcData.param2 == 0) { // plays when you or the game closes the window
		//console.log('closing window')
	} else if (spearfish_message.parsedIpcData.param2 == 6) { // the window opens
		// param3 has some unknown (or garbage) data in it
		...
		//console.log('wariness mod %s%%', (spearfish_message.parsedIpcData.param3 / 90000) * 100)
		...
		// speeds, slower to faster: 150, 200, 300, 350, 400
